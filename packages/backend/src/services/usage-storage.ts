    ...
    try {
      const data = await db
        .select({
          ...
          avgPowerWatts: schema.requestUsage.avgPowerWatts,
          durationSeconds: schema.requestUsage.durationSeconds,
          attributionMethod: schema.requestUsage.attributionMethod,
          attributionRatio: schema.requestUsage.attributionRatio,
          ratioWasCapped: schema.requestUsage.ratioWasCapped,
          uncappedEnergyKwh: schema.requestUsage.uncappedEnergyKwh,
          updatedAt: schema.requestUsage.updatedAt,
      ...
      const mappedData: UsageRecord[] = data.map((row: any) => ({
        ...
        kwhUsed: row.kwhUsed,
        avgPowerWatts: row.avgPowerWatts ?? null,
        durationSeconds: row.durationSeconds ?? null,
        attributionMethod: row.attributionMethod ?? null,
        attributionRatio: row.attributionRatio ?? null,
        ratioWasCapped: row.ratioWasCapped != null ? !!row.ratioWasCapped : null,
        uncappedEnergyKwh: row.uncappedEnergyKwh ?? null,
